...
#include "FoundationControllerDisconnectedScreen.generated.h"
...
class UFoundationControllerDisconnectedScreen : public UCommonActivatableWidget
{
	GENERATED_BODY()
public:
	UFoundationControllerDisconnectedScreen(const FObjectInitializer& ObjectInitializer);
