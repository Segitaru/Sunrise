...
#include "FoundationLoadingScreenSubsystem.generated.h"

#define UE_API FOUNDATIONWIDGETSCORE_API
 ...
 */
UCLASS(MinimalAPI)
class UFoundationLoadingScreenSubsystem : public UGameInstanceSubsystem
{
	GENERATED_BODY()

public:
	UE_API UFoundationLoadingScreenSubsystem();
