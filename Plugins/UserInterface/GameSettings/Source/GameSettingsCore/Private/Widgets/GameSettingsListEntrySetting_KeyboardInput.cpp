...
#include "Widgets/GameSettingsListEntrySetting_KeyboardInput.h"

#include "CommonUIExtensions.h"
#include "CustomSettings/GameSettingKeyboardInput.h"
...
#include UE_INLINE_GENERATED_CPP_BY_NAME(GameSettingsListEntrySetting_KeyboardInput)

#define LOCTEXT_NAMESPACE "GameSettings"

UE_DEFINE_GAMEPLAY_TAG_STATIC(PressAnyKeyLayer, "UI.Layer.Modal");

void UGameSettingsListEntrySetting_KeyboardInput::SetSetting(UGameSetting* InSetting)
{
	KeyboardInputSetting = CastChecked<UGameSettingKeyboardInput>(InSetting);
...
void UGameSettingsListEntrySetting_KeyboardInput::NativeOnInitialized()
{
...
void UGameSettingsListEntrySetting_KeyboardInput::HandlePrimaryKeyClicked()
{
...
void UGameSettingsListEntrySetting_KeyboardInput::HandleSecondaryKeyClicked()
{
	UGameSettingPressAnyKey* PressAnyKeyPanel = CastChecked<UGameSettingPressAnyKey>(
		UCommonUIExtensions::PushContentToLayer_ForPlayer(GetOwningLocalPlayer(), PressAnyKeyLayer, PressAnyKeyPanelClass));
...
void UGameSettingsListEntrySetting_KeyboardInput::HandlePrimaryKeySelected(FKey InKey, UGameSettingPressAnyKey* PressAnyKeyPanel)
{
	PressAnyKeyPanel->OnKeySelected.RemoveAll(this);
	ChangeBinding(0, InKey);
}

void UGameSettingsListEntrySetting_KeyboardInput::HandleSecondaryKeySelected(FKey InKey, UGameSettingPressAnyKey* PressAnyKeyPanel)
{
	PressAnyKeyPanel->OnKeySelected.RemoveAll(this);
	ChangeBinding(1, InKey);
}

void UGameSettingsListEntrySetting_KeyboardInput::HandlePrimaryDuplicateKeySelected(
...
void UGameSettingsListEntrySetting_KeyboardInput::HandleSecondaryDuplicateKeySelected(
	FKey InKey, UKeyAlreadyBoundWarning* DuplicateKeyPressAnyKeyPanel) const
{
	DuplicateKeyPressAnyKeyPanel->OnKeySelected.RemoveAll(this);
...
void UGameSettingsListEntrySetting_KeyboardInput::ChangeBinding(int32 InKeyBindSlot, FKey InKey)
{
...
void UGameSettingsListEntrySetting_KeyboardInput::HandleKeySelectionCanceled(UGameSettingPressAnyKey* PressAnyKeyPanel)
{
	PressAnyKeyPanel->OnKeySelectionCanceled.RemoveAll(this);
}

void UGameSettingsListEntrySetting_KeyboardInput::HandleKeySelectionCanceled(UKeyAlreadyBoundWarning* PressAnyKeyPanel)
{
	PressAnyKeyPanel->OnKeySelectionCanceled.RemoveAll(this);
}

void UGameSettingsListEntrySetting_KeyboardInput::HandleClearClicked()
{
	KeyboardInputSetting->ChangeBinding(0, EKeys::Invalid);
	KeyboardInputSetting->ChangeBinding(1, EKeys::Invalid);
}

void UGameSettingsListEntrySetting_KeyboardInput::HandleResetToDefaultClicked()
{
	KeyboardInputSetting->ResetToDefault();
}

void UGameSettingsListEntrySetting_KeyboardInput::OnSettingChanged()
{
	Refresh();
}

void UGameSettingsListEntrySetting_KeyboardInput::Refresh()
{
...
void UGameSettingsListEntrySetting_KeyboardInput::NativeOnEntryReleased()
{
