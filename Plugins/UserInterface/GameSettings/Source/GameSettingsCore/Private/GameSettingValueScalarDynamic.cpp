...
FSettingScalarFormatFunction UGameSettingValueScalarDynamic::Raw(
...
void UGameSettingValueScalarDynamic::OnInitialized()
{
	...
	ensureAlwaysMsgf(Getter->Resolve(LocalPlayer),
		TEXT("%s: %s did not resolve, are all functions and properties valid, and are they UFunctions/UProperties?"),
