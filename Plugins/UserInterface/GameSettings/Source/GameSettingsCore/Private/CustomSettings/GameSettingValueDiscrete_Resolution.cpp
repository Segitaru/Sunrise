	...
	if (ensure(PlatformApplication.IsValid()))
	{
		...
		if (!DisplayMetricsChangedEvent.IsBoundToObject(this))
		{
			DisplayMetricsChangedHandle =
				DisplayMetricsChangedEvent.AddUObject(this, &UGameSettingValueDiscrete_Resolution::OnDisplayMetricsChanged);
		}
	}
...
void UGameSettingValueDiscrete_Resolution::InitializeResolutions()
{
	...
	// Determine available windowed modes
	{
		...
		{
			MaxResolution =
				FIntPoint(CurrentDisplayMetrics.PrimaryDisplayWorkAreaRect.Right - CurrentDisplayMetrics.PrimaryDisplayWorkAreaRect.Left,
...
TArrayView<const TSharedPtr<UGameSettingValueDiscrete_Resolution::FScreenResolutionEntry>> UGameSettingValueDiscrete_Resolution::
	GetSelectedResolutionList() const
{
...
bool UGameSettingValueDiscrete_Resolution::ShouldAllowFullScreenResolution(
...
void UGameSettingValueDiscrete_Resolution::GetStandardWindowResolutions(
	const FIntPoint& MinResolution, const FIntPoint& MaxResolution, float MinAspectRatio, TArray<FIntPoint>& OutResolutions)
{
