...
#include "GameSafeZoneEditor.generated.h"
...
UCLASS(Abstract)
class UGameSafeZoneEditor : public UCommonActivatableWidget, public IGameSettingActionInterface
{
	GENERATED_BODY()
...
public:
	UGameSafeZoneEditor(const FObjectInitializer& Initializer);
