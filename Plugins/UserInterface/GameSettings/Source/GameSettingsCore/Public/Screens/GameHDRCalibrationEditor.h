...
#include "GameHDRCalibrationEditor.generated.h"
...
UCLASS(Abstract)
class UGameHDRCalibrationEditor : public UCommonActivatableWidget, public IGameSettingActionInterface
{
	GENERATED_BODY()

public:
	UGameHDRCalibrationEditor(const FObjectInitializer& Initializer);
