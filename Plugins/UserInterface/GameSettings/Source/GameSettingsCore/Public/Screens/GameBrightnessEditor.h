...
#include "GameBrightnessEditor.generated.h"
...
UCLASS(Abstract)
class UGameBrightnessEditor : public UCommonActivatableWidget, public IGameSettingActionInterface
{
	GENERATED_BODY()
...
public:
	UGameBrightnessEditor(const FObjectInitializer& Initializer);
