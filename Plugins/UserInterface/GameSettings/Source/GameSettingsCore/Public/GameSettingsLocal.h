...
public:
	...
	GAMESETTINGSCORE_API static UGameSettingsLocal* Get();
	...
	GAMESETTINGSCORE_API void OnExperienceLoaded();
	GAMESETTINGSCORE_API void OnHotfixDeviceProfileApplied();

	//////////////////////////////////////////////////////////////////
	// Frontend state

public:
	GAMESETTINGSCORE_API void SetShouldUseFrontendPerformanceSettings(bool bInFrontEnd);
...
public:
	...
	DECLARE_EVENT(UGameSettingsLocal, FPerfStatSettingsChanged);
	...
	DECLARE_EVENT(UGameSettingsLocal, FLatencyFlashInidicatorSettingChanged);
	UFUNCTION()
	...
	DECLARE_EVENT(UGameSettingsLocal, FLatencyStatEnabledSettingChanged);
...
private:
	...
	// Audio - Volume
public:
	DECLARE_EVENT_OneParam(UGameSettingsLocal, FAudioDeviceChanged, const FString& /*DeviceId*/);
