...
#include UE_INLINE_GENERATED_CPP_BY_NAME(EFHotfixManager)

int32 UEFHotfixManager::GameHotfixCounter = 0;

UEFHotfixManager::UEFHotfixManager()
{
#if !UE_BUILD_SHIPPING
	OnScreenMessageHandle = FCoreDelegates::OnGetOnScreenMessages.AddUObject(this, &UEFHotfixManager::GetOnScreenMessages);
...
void UEFHotfixManager::Init()
{
	Super::Init();
}

void UEFHotfixManager::OnHotfixCompleted(EHotfixResult HotfixResult)
{
...
bool UEFHotfixManager::WantsHotfixProcessing(const FCloudFileHeader& FileHeader)
{
...
bool UEFHotfixManager::HotfixIniFile(const FString& FileName, const FString& IniData)
{
...
bool UEFHotfixManager::ApplyHotfixProcessing(const FCloudFileHeader& FileHeader)
{
...
bool UEFHotfixManager::ShouldWarnAboutMissingWhenPatchingFromIni(const FString& AssetPath) const
{
	return AssetPath.StartsWith(TEXT("/Engine/")) || AssetPath.StartsWith(TEXT("/Game/"));
}

void UEFHotfixManager::PatchAssetsFromIniFiles()
{
#if ENABLE_SHARED_MEMORY_TRACKER
...
void UEFHotfixManager::OnHotfixAvailablityCheck(
...
#if !UE_BUILD_SHIPPING
void UEFHotfixManager::GetOnScreenMessages(TMultiMap<FCoreDelegates::EOnScreenMessageSeverity, FText>& OutMessages)
{
	// TODO Any messages/errors.
}
#endif // !UE_BUILD_SHIPPING

void UEFHotfixManager::RequestPatchAssetsFromIniFiles()
{
