...
#include "EFCameraMode.h"
#include "EFPenetrationAvoidanceFeeler.h"

#include "EFCameraMode_ThirdPerson.generated.h"

class UCurveVector;

/**
 * UEFCameraMode_ThirdPerson
 *
 *	A basic third person camera mode.
 */
UCLASS(Abstract, Blueprintable)
class UEFCameraMode_ThirdPerson : public UEFCameraMode
{
	GENERATED_BODY()
...
protected:
	...
	void PreventCameraPenetration(class AActor const& ViewTarget, FVector const& SafeLoc, FVector& CameraLoc, float const& DeltaTime,
...
public:
	...
	TArray<FEFPenetrationAvoidanceFeeler> PenetrationAvoidanceFeelers;
