...
#include "EFUICameraManagerComponent.generated.h"

class AEFPlayerCameraManager;
...
UCLASS(Transient, Within = EFPlayerCameraManager)
class UEFUICameraManagerComponent : public UActorComponent
{
	GENERATED_BODY()

public:
	static UEFUICameraManagerComponent* GetComponent(APlayerController* PC);

public:
	UEFUICameraManagerComponent();
