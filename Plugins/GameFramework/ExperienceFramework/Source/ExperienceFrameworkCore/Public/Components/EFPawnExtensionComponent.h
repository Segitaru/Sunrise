...
#include "EFPawnExtensionComponent.generated.h"
 ...
 */
UCLASS(MinimalAPI)
class UEFPawnExtensionComponent : public UPawnComponent, public IGameFrameworkInitStateInterface
{
	GENERATED_BODY()

public:
	UE_API UEFPawnExtensionComponent(const FObjectInitializer& ObjectInitializer);
	...
	UFUNCTION(BlueprintPure, Category = "EF|Pawn")
	static UEFPawnExtensionComponent* FindPawnExtensionComponent(const AActor* Actor)
	{
		return (Actor ? Actor->FindComponentByClass<UEFPawnExtensionComponent>() : nullptr);
	}
	...
	UE_API void SetPawnData(const UEFPawnData* InPawnData);

	/** Gets the current ability system component, which may be owned by a different actor */
	UFUNCTION(BlueprintCallable, Category = "EF|Pawn", meta = (DeterminesOutputType = "ByClass"))
	...
	UE_API void InitializeAbilitySystem(UAbilitySystemComponent* InASC, AActor* InOwnerActor);
...
protected:
	...
	UPROPERTY(EditInstanceOnly, ReplicatedUsing = OnRep_PawnData, Category = "EF|Pawn")
	TObjectPtr<const UEFPawnData> PawnData;
