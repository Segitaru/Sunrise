...
#include "EFTextHotfixConfig.generated.h"
...
class UEFTextHotfixConfig : public UDeveloperSettings
{
	GENERATED_BODY()

public:
	UEFTextHotfixConfig(const FObjectInitializer& ObjectInitializer);
