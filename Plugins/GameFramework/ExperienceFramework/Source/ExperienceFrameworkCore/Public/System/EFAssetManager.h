...
#include "EFAssetManagerStartupJob.h"
#include "Engine/AssetManager.h"
#include "Templates/SubclassOf.h"

#include "EFAssetManager.generated.h"
...
class UEFAssetManager : public UAssetManager
{
	GENERATED_BODY()

public:
	UE_API UEFAssetManager();

	// Returns the AssetManager singleton object.
	static UE_API UEFAssetManager& Get();
	...
	UE_API const UEFGameData& GetGameData();
	UE_API const UEFPawnData* GetDefaultPawnData() const;
...
protected:
	...
	TSoftObjectPtr<UEFGameData> EFGameDataPath;
	...
	UPROPERTY(Config, EditDefaultsOnly)
	TSoftObjectPtr<UEFPawnData> DefaultPawnData;
...
private:
	...
	TArray<FEFAssetManagerStartupJob> StartupJobs;
...
template <typename AssetType>
AssetType* UEFAssetManager::GetAsset(const TSoftObjectPtr<AssetType>& AssetPointer, bool bKeepInMemory)
{
...
template <typename AssetType>
TSubclassOf<AssetType> UEFAssetManager::GetSubclass(const TSoftClassPtr<AssetType>& AssetPointer, bool bKeepInMemory)
{
