...
#include "EFGameplayCueManager.generated.h"
...
/**
 * UEFGameplayCueManager
 *
 * Game-specific manager for gameplay cues
 */
UCLASS()
class UEFGameplayCueManager : public UGameplayCueManager
{
	GENERATED_BODY()

public:
	UEFGameplayCueManager(const FObjectInitializer& ObjectInitializer = FObjectInitializer::Get());

	static UEFGameplayCueManager* Get();
