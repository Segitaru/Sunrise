...
#include "EFGameFeaturePolicy.generated.h"
...
class UEFGameFeaturePolicy : public UDefaultGameFeaturesProjectPolicies
{
	GENERATED_BODY()

public:
	EXPERIENCEFRAMEWORKCORE_API static UEFGameFeaturePolicy& Get();

	UEFGameFeaturePolicy(const FObjectInitializer& ObjectInitializer);
...
// checked
UCLASS()
class UEFGameFeature_HotfixManager : public UObject, public IGameFeatureStateChangeObserver
{
	GENERATED_BODY()
...
// checked
UCLASS()
class UEFGameFeature_AddGameplayCuePaths : public UObject, public IGameFeatureStateChangeObserver
{
	GENERATED_BODY()
