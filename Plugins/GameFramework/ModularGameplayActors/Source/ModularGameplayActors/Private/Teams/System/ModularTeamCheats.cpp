...
#include UE_INLINE_GENERATED_CPP_BY_NAME(ModularTeamCheats)

//////////////////////////////////////////////////////////////////////
// UModularTeamCheats

void UModularTeamCheats::CycleTeam()
{
	if (UModularTeamSubsystem* TeamSubsystem = UWorld::GetSubsystem<UModularTeamSubsystem>(GetWorld()))
	{
...
void UModularTeamCheats::SetTeam(int32 TeamID)
{
	if (UModularTeamSubsystem* TeamSubsystem = UWorld::GetSubsystem<UModularTeamSubsystem>(GetWorld()))
	{
...
void UModularTeamCheats::ListTeams()
{
	if (UModularTeamSubsystem* TeamSubsystem = UWorld::GetSubsystem<UModularTeamSubsystem>(GetWorld()))
	{
		const TArray<int32> TeamIDs = TeamSubsystem->GetTeamIDs();
