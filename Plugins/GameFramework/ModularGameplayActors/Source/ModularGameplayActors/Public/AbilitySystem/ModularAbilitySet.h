...
public:
	...
	TSubclassOf<UModularGameplayAbility> Ability;
...
public:
	...
	MODULARGAMEPLAYACTORS_API void TakeFromAbilitySystem(UModularAbilitySystemComponent* ModularASC);
...
public:
	...
	MODULARGAMEPLAYACTORS_API void GiveToAbilitySystem(UModularAbilitySystemComponent* ModularASC, FModularAbilitySet_GrantedHandles* OutGrantedHandles, UObject* SourceObject = nullptr) const;
