...
MODULARGAMEPLAYACTORS_API UE_DECLARE_GAMEPLAY_TAG_EXTERN(TAG_Gameplay_AbilityInputBlocked);

/**
 * UModularAbilitySystemComponent
 *
 *	Base ability system component class used by this project.
 */
UCLASS(MinimalAPI)
class UModularAbilitySystemComponent : public UAbilitySystemComponent
{
	GENERATED_BODY()
...
public:
	...
	UE_API void CancelActivationGroupAbilities(
	...
	UE_API void GetAbilityTargetData(const FGameplayAbilitySpecHandle AbilityHandle, FGameplayAbilityActivationInfo ActivationInfo,
	...
	UE_API const FGameplayTagContainer& GetPressedInputTags();
...
protected:
	...
	UE_API virtual void NotifyAbilityFailed(
	...
	UE_API virtual void ApplyAbilityBlockAndCancelTags(const FGameplayTagContainer& AbilityTags, UGameplayAbility* RequestingAbility,
	...
	UE_API virtual void HandleChangeAbilityCanBeCanceled(
		const FGameplayTagContainer& AbilityTags, UGameplayAbility* RequestingAbility, bool bCanBeCanceled) override;
