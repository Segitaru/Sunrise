...
class IModularAbilitySourceInterface
{
	...
	virtual float GetModularAttenuation(const UModular* Modular, const FGameplayTagContainer* SourceTags = nullptr, const FGameplayTagContainer* TargetTags = nullptr) const = 0;
};
