...
/**
 * EModularCameraModeBlendFunction
 *
 *	Blend function used for transitioning between camera modes.
 */
UENUM(BlueprintType)
enum class EModularCameraModeBlendFunction : uint8
{
...
class UModularCameraMode : public UObject
{
	GENERATED_BODY()
...
public:
	...
	const FModularCameraModeView& GetCameraModeView() const { return View; }
...
protected:
	...
	UPROPERTY(EditDefaultsOnly, Category = "Blending")
	EModularCameraModeBlendFunction BlendFunction;
 ...
 */
UCLASS()
class UModularCameraModeStack : public UObject
{
	GENERATED_BODY()
...
public:
	...
	bool EvaluateStack(float DeltaTime, FModularCameraModeView& OutCameraModeView);
...
protected:
	...
	UPROPERTY()
	TArray<TObjectPtr<UModularCameraMode>> CameraModeInstances;
