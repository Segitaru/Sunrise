...
#include "ModularGameMatchComponent.generated.h"
...
UCLASS()
class MODULARGAMEPLAYACTORS_API UModularGameMatchComponent : public UGameStateComponent
{
	GENERATED_BODY()

public:
	UModularGameMatchComponent(const FObjectInitializer& ObjectInitializer);
