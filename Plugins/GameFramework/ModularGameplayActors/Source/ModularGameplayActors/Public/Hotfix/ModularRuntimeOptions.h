...
#include "ModularRuntimeOptions.generated.h"
...
/**
 * UModularRuntimeOptions: Supports checking at runtime whether features are enabled/disabled, changing
...
class UModularRuntimeOptions : public URuntimeOptionsBase
{
	GENERATED_BODY()

public:
	static UE_API const UModularRuntimeOptions& Get();

	UE_API UModularRuntimeOptions();

	UFUNCTION(BlueprintPure, Category = Options)
	static UE_API UModularRuntimeOptions* GetRuntimeOptions();
};
